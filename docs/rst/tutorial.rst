...
Shunt objects can be accessed through their buses or through the GWB object. The attributes of shunts can be determined by using the *dir()* function.
